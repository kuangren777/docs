...
* CaMeL AI 平台支持 gemini 原生与 OpenAI 兼容则 2 种请求格式
...
VEO 3.0 是由 Google DeepMind 开发的最新先进视频生成模型。使用 [VEO 3.0](https://camel.kr777.top/models?model=veo-3.0-generate-preview)，您可以生成具有以下特点的视频：
...
<CodeGroup>
  ...
  curl "https://camel.kr777.top/gemini/v1beta/models/veo-3.0-generate-preview/operations/ff5***?key=sk-***"
  ```
