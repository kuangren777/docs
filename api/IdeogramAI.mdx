...
`POST` [https://aihubmix.com/ideogram/generate\\](https://api.kr777.top/ideogram/generate\\) 根据给定提示词和可选参数同步生成图像。图像链接的有效期有限；如果你想保留图像，必须下载保存。
...
`POST` [https://aihubmix.com/ideogram/edit](https://api.kr777.top/ideogram/edit)
...
`POST` [https://aihubmix.com/ideogram/remix](https://api.kr777.top/ideogram/remix)
...
`POST` [https://aihubmix.com/ideogram/upscale](https://api.kr777.top/ideogram/upscale)
...
`POST` [https://aihubmix.com/ideogram/describe](https://api.kr777.top/ideogram/describe)
